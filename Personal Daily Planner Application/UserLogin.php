						...
						<form action="UserLogin_db.php" method="post">
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<hr>
									<p class="reset">Register your <a tabindex="4" href="UserRegister.php" title="Recover your username or password">account</a></p>
									<p class="reset">Or continue as a <a tabindex="5" href="GuestLogin.php">Guest</a></p>
								</div>
							</fieldset>
						</form>				
					</div>
