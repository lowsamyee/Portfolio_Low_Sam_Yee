    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				<h4><span>Manager Login</span></h4>
			</section>			
			<section class="main-content">				
				<div class="row">
					<div class="span5">					
						<h4 class="title"><span class="text"><strong>Login</strong> Form</span></h4>
						<form action="ManagerLogin_db.php" method="post">
							...
							<fieldset>
								...
								<div class="control-group">
									...
									<hr>
									<p class="reset">Register your <a tabindex="4" href="ManagerRegister.php" title="Recover your username or password">account</a></p>
								</div>
							</fieldset>
						</form>				
					</div>
